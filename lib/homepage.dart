...
void main() => runApp(MaterialApp(home: HomePage(accountId: 1))); // Example with accountId

class HomePage extends StatefulWidget {
  final int accountId; // Accept accountId parameter
  HomePage({required this.accountId}); // Constructor accepting accountId
...
class _HomePageState extends State<HomePage> {
  int _currentPageIndex = 2; // Current page index
  ...
  bool _isNotificationEnabled = true; // Default notification switch state
  ...
  Widget build(BuildContext context) {
    ...
    // Now the accountId can be accessed using widget.accountId
  ...
  Widget _buildBody(BuildContext context, User? user) {
    switch (_currentPageIndex) {
      case 0:
        return _buildPopularRecipePage(context);
      case 3:
   ...
   Widget _buildPopularRecipePage(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          Container(
          ...
          // Additional buttons and icons on the page
        ],
      ),
    );
  }
  ...
  Widget _buildHistoryPage() {
    List<Map<String, dynamic>> historicalRecipes = [
      ...
      // Add more historical recipes here
    ];
  ...
  Widget _buildSettingItem(String title, Widget trailingWidget) {
    return Padding(
